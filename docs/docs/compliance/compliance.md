...
Compliance report is currently supported in the following targets (vul sub-commands):
...
For example: `vul k8s cluster --compliance k8s-nsa` (see below for built-in and custom reports)

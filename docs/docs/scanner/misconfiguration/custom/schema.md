...
can be found [here](https://github.com/khulnasoft-lab/defsec/blob/master/pkg/rego/schemas/dockerfile.json)
...
1. [Docker](https://github.com/khulnasoft-lab/defsec/blob/master/pkg/rego/schemas/dockerfile.json)
2. [Kubernetes](https://github.com/khulnasoft-lab/defsec/blob/master/pkg/rego/schemas/kubernetes.json)
3. [Cloud](https://github.com/khulnasoft-lab/defsec/blob/master/pkg/rego/schemas/cloud.json)

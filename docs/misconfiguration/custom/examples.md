...
Vul parses HCL files and converts into structured data.
...
[k8s]:https://github.com/khulnasoft-lab/vul/tree/{{ git.commit }}/examples/misconf/custom-policy/kubernetes/
[dockerfile]:https://github.com/khulnasoft-lab/vul/tree/{{ git.commit }}/examples/misconf/custom-policy/dockerfile/
[compose]:https://github.com/khulnasoft-lab/vul/tree/{{ git.commit }}/examples/misconf/custom-policy/docker-compose/
[hcl]:https://github.com/khulnasoft-lab/vul/tree/{{ git.commit }}/examples/misconf/custom-policy/hcl/
[serverless]:https://github.com/khulnasoft-lab/vul/tree/{{ git.commit }}/examples/misconf/custom-policy/serverless/
[tfplan]:https://github.com/khulnasoft-lab/vul/tree/{{ git.commit }}/examples/misconf/custom-policy/terraform-plan/
...
[custom]: https://github.com/khulnasoft-lab/vul/tree/{{ git.commit }}/examples/misconf/custom-policy
[data]: https://github.com/khulnasoft-lab/vul/tree/{{ git.commit }}/examples/misconf/custom-data
[combine]: https://github.com/khulnasoft-lab/vul/tree/{{ git.commit }}/examples/misconf/combine
[go-testing]: https://github.com/khulnasoft-lab/vul/tree/{{ git.commit }}/examples/misconf/go-testing

...
```bash
$ vul conf --severity HIGH,CRITICAL configs
...
```bash
$ vul conf --file-patterns "dockerfile:.*.docker" --file-patterns "yaml:deployment" configs
vul conf --severity HIGH,CRITICAL --file-patterns "dockerfile:.*.docker" --file-patterns "yaml:deployment" configs

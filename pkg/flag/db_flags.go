...
const defaultJavaDBRepository = "ghcr.io/khulnasoft-lab/vul-java-db"
...
func (f *DBFlagGroup) ToOptions() (DBOptions, error) {
	...
	if light {
		log.Logger.Warn("'--light' option is deprecated and will be removed. See also: https://github.com/khulnasoft-lab/vul/discussions/1649")
	}

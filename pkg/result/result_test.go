			...
			expectedVulnerabilities: []types.DetectedVulnerability{
				{
					...
					PrimaryURL:     "https://avd.khulnasoft.com/nvd/cve-2019-0002",
				},
			},
		},
		{
			...
			expectedVulnerabilities: []types.DetectedVulnerability{
				{
					...
					PrimaryURL: "https://avd.khulnasoft.com/nvd/cve-2019-0003",
				},
			},
		},
		{
			...
			expectedVulnerabilities: []types.DetectedVulnerability{
				{
					...
					PrimaryURL:     "https://avd.khulnasoft.com/nvd/cve-2019-0004",
				},
			},
		},
		{
			...
			expectedVulnerabilities: []types.DetectedVulnerability{
				{
					...
					PrimaryURL: "https://avd.khulnasoft.com/nvd/cve-2020-0002",
				},
			},
		},
		{
			...
			expectedVulnerabilities: []types.DetectedVulnerability{
				{
					...
					PrimaryURL:     "https://avd.khulnasoft.com/nvd/cve-2019-0005",
				},
			},
		},
		{
...
func TestClient_getPrimaryURL(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: "https://avd.khulnasoft.com/nvd/cve-2014-8484",
		},
		{
			name: "RUSTSEC",
			args: args{

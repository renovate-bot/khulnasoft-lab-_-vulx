...
var file_rpc_cache_service_proto_goTypes = []interface{}{
	(*ArtifactInfo)(nil),            // 0: vul.cache.v1.ArtifactInfo
	(*PutArtifactRequest)(nil),      // 1: vul.cache.v1.PutArtifactRequest
	(*BlobInfo)(nil),                // 2: vul.cache.v1.BlobInfo
	(*PutBlobRequest)(nil),          // 3: vul.cache.v1.PutBlobRequest
	(*PutResponse)(nil),             // 4: vul.cache.v1.PutResponse
	(*MissingBlobsRequest)(nil),     // 5: vul.cache.v1.MissingBlobsRequest
	(*MissingBlobsResponse)(nil),    // 6: vul.cache.v1.MissingBlobsResponse
	(*DeleteBlobsRequest)(nil),      // 7: vul.cache.v1.DeleteBlobsRequest
	(*timestamppb.Timestamp)(nil),   // 8: google.protobuf.Timestamp
	(*common.Package)(nil),          // 9: vul.common.Package
	(*common.OS)(nil),               // 10: vul.common.OS
	(*common.Repository)(nil),       // 11: vul.common.Repository
	(*common.PackageInfo)(nil),      // 12: vul.common.PackageInfo
	(*common.Application)(nil),      // 13: vul.common.Application
	(*common.Misconfiguration)(nil), // 14: vul.common.Misconfiguration
	(*common.CustomResource)(nil),   // 15: vul.common.CustomResource
	(*common.Secret)(nil),           // 16: vul.common.Secret
	(*emptypb.Empty)(nil),           // 17: google.protobuf.Empty
}
var file_rpc_cache_service_proto_depIdxs = []int32{
	8,  // 0: vul.cache.v1.ArtifactInfo.created:type_name -> google.protobuf.Timestamp
	9,  // 1: vul.cache.v1.ArtifactInfo.history_packages:type_name -> vul.common.Package
	0,  // 2: vul.cache.v1.PutArtifactRequest.artifact_info:type_name -> vul.cache.v1.ArtifactInfo
	10, // 3: vul.cache.v1.BlobInfo.os:type_name -> vul.common.OS
	11, // 4: vul.cache.v1.BlobInfo.repository:type_name -> vul.common.Repository
	12, // 5: vul.cache.v1.BlobInfo.package_infos:type_name -> vul.common.PackageInfo
	13, // 6: vul.cache.v1.BlobInfo.applications:type_name -> vul.common.Application
	14, // 7: vul.cache.v1.BlobInfo.misconfigurations:type_name -> vul.common.Misconfiguration
	15, // 8: vul.cache.v1.BlobInfo.custom_resources:type_name -> vul.common.CustomResource
	16, // 9: vul.cache.v1.BlobInfo.secrets:type_name -> vul.common.Secret
	2,  // 10: vul.cache.v1.PutBlobRequest.blob_info:type_name -> vul.cache.v1.BlobInfo
	10, // 11: vul.cache.v1.PutResponse.os:type_name -> vul.common.OS
	1,  // 12: vul.cache.v1.Cache.PutArtifact:input_type -> vul.cache.v1.PutArtifactRequest
	3,  // 13: vul.cache.v1.Cache.PutBlob:input_type -> vul.cache.v1.PutBlobRequest
	5,  // 14: vul.cache.v1.Cache.MissingBlobs:input_type -> vul.cache.v1.MissingBlobsRequest
	7,  // 15: vul.cache.v1.Cache.DeleteBlobs:input_type -> vul.cache.v1.DeleteBlobsRequest
	17, // 16: vul.cache.v1.Cache.PutArtifact:output_type -> google.protobuf.Empty
	17, // 17: vul.cache.v1.Cache.PutBlob:output_type -> google.protobuf.Empty
	6,  // 18: vul.cache.v1.Cache.MissingBlobs:output_type -> vul.cache.v1.MissingBlobsResponse
	17, // 19: vul.cache.v1.Cache.DeleteBlobs:output_type -> google.protobuf.Empty

...
var file_rpc_cache_service_proto_goTypes = []interface{}{
	...
	(*common.Package)(nil),          // 8: vul.common.Package
	(*common.OS)(nil),               // 9: vul.common.OS
	(*common.PackageInfo)(nil),      // 10: vul.common.PackageInfo
	(*common.Application)(nil),      // 11: vul.common.Application
	(*common.Misconfiguration)(nil), // 12: vul.common.Misconfiguration
	(*emptypb.Empty)(nil),           // 13: google.protobuf.Empty
}
var file_rpc_cache_service_proto_depIdxs = []int32{
	7,  // 0: vul.cache.v1.ArtifactInfo.created:type_name -> google.protobuf.Timestamp
	8,  // 1: vul.cache.v1.ArtifactInfo.history_packages:type_name -> vul.common.Package
	0,  // 2: vul.cache.v1.PutArtifactRequest.artifact_info:type_name -> vul.cache.v1.ArtifactInfo
	9,  // 3: vul.cache.v1.BlobInfo.os:type_name -> vul.common.OS
	10, // 4: vul.cache.v1.BlobInfo.package_infos:type_name -> vul.common.PackageInfo
	11, // 5: vul.cache.v1.BlobInfo.applications:type_name -> vul.common.Application
	12, // 6: vul.cache.v1.BlobInfo.misconfigurations:type_name -> vul.common.Misconfiguration
	2,  // 7: vul.cache.v1.PutBlobRequest.blob_info:type_name -> vul.cache.v1.BlobInfo
	9,  // 8: vul.cache.v1.PutResponse.os:type_name -> vul.common.OS
	1,  // 9: vul.cache.v1.Cache.PutArtifact:input_type -> vul.cache.v1.PutArtifactRequest
	3,  // 10: vul.cache.v1.Cache.PutBlob:input_type -> vul.cache.v1.PutBlobRequest
	5,  // 11: vul.cache.v1.Cache.MissingBlobs:input_type -> vul.cache.v1.MissingBlobsRequest
	13, // 12: vul.cache.v1.Cache.PutArtifact:output_type -> google.protobuf.Empty
	13, // 13: vul.cache.v1.Cache.PutBlob:output_type -> google.protobuf.Empty
	6,  // 14: vul.cache.v1.Cache.MissingBlobs:output_type -> vul.cache.v1.MissingBlobsResponse

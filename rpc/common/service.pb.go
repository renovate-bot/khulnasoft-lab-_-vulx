...
type DetectedMisconfiguration struct {
	...
	Severity      Severity       `protobuf:"varint,8,opt,name=severity,proto3,enum=vul.common.Severity" json:"severity,omitempty"`
...
type Vulnerability struct {
	...
	VendorSeverity     map[string]Severity    `protobuf:"bytes,21,rep,name=vendor_severity,json=vendorSeverity,proto3" json:"vendor_severity,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=vul.common.Severity"`
...
type DetectedLicense struct {
	...
	Severity   Severity                        `protobuf:"varint,1,opt,name=severity,proto3,enum=vul.common.Severity" json:"severity,omitempty"`
	Category   DetectedLicense_LicenseCategory `protobuf:"varint,2,opt,name=category,proto3,enum=vul.common.DetectedLicense_LicenseCategory" json:"category,omitempty"`
...
var file_rpc_common_service_proto_goTypes = []interface{}{
	(Severity)(0),                        // 0: vul.common.Severity
	(DetectedLicense_LicenseCategory)(0), // 1: vul.common.DetectedLicense.LicenseCategory
	(*OS)(nil),                           // 2: vul.common.OS
	(*Repository)(nil),                   // 3: vul.common.Repository
	(*PackageInfo)(nil),                  // 4: vul.common.PackageInfo
	(*Application)(nil),                  // 5: vul.common.Application
	(*Package)(nil),                      // 6: vul.common.Package
	(*Misconfiguration)(nil),             // 7: vul.common.Misconfiguration
	(*MisconfResult)(nil),                // 8: vul.common.MisconfResult
	(*PolicyMetadata)(nil),               // 9: vul.common.PolicyMetadata
	(*DetectedMisconfiguration)(nil),     // 10: vul.common.DetectedMisconfiguration
	(*Vulnerability)(nil),                // 11: vul.common.Vulnerability
	(*DataSource)(nil),                   // 12: vul.common.DataSource
	(*Layer)(nil),                        // 13: vul.common.Layer
	(*CauseMetadata)(nil),                // 14: vul.common.CauseMetadata
	(*CVSS)(nil),                         // 15: vul.common.CVSS
	(*CustomResource)(nil),               // 16: vul.common.CustomResource
	(*Line)(nil),                         // 17: vul.common.Line
	(*Code)(nil),                         // 18: vul.common.Code
	(*SecretFinding)(nil),                // 19: vul.common.SecretFinding
	(*Secret)(nil),                       // 20: vul.common.Secret
	(*DetectedLicense)(nil),              // 21: vul.common.DetectedLicense
	nil,                                  // 22: vul.common.Vulnerability.CvssEntry
	nil,                                  // 23: vul.common.Vulnerability.VendorSeverityEntry
	(*timestamppb.Timestamp)(nil),        // 24: google.protobuf.Timestamp
	(*structpb.Value)(nil),               // 25: google.protobuf.Value
}
var file_rpc_common_service_proto_depIdxs = []int32{
	6,  // 0: vul.common.PackageInfo.packages:type_name -> vul.common.Package
	6,  // 1: vul.common.Application.libraries:type_name -> vul.common.Package
	13, // 2: vul.common.Package.layer:type_name -> vul.common.Layer
	8,  // 3: vul.common.Misconfiguration.successes:type_name -> vul.common.MisconfResult
	8,  // 4: vul.common.Misconfiguration.warnings:type_name -> vul.common.MisconfResult
	8,  // 5: vul.common.Misconfiguration.failures:type_name -> vul.common.MisconfResult
	8,  // 6: vul.common.Misconfiguration.exceptions:type_name -> vul.common.MisconfResult
	9,  // 7: vul.common.MisconfResult.policy_metadata:type_name -> vul.common.PolicyMetadata
	14, // 8: vul.common.MisconfResult.cause_metadata:type_name -> vul.common.CauseMetadata
	0,  // 9: vul.common.DetectedMisconfiguration.severity:type_name -> vul.common.Severity
	13, // 10: vul.common.DetectedMisconfiguration.layer:type_name -> vul.common.Layer
	14, // 11: vul.common.DetectedMisconfiguration.cause_metadata:type_name -> vul.common.CauseMetadata
	0,  // 12: vul.common.Vulnerability.severity:type_name -> vul.common.Severity
	13, // 13: vul.common.Vulnerability.layer:type_name -> vul.common.Layer
	22, // 14: vul.common.Vulnerability.cvss:type_name -> vul.common.Vulnerability.CvssEntry
	24, // 15: vul.common.Vulnerability.published_date:type_name -> google.protobuf.Timestamp
	24, // 16: vul.common.Vulnerability.last_modified_date:type_name -> google.protobuf.Timestamp
	25, // 17: vul.common.Vulnerability.custom_advisory_data:type_name -> google.protobuf.Value
	25, // 18: vul.common.Vulnerability.custom_vuln_data:type_name -> google.protobuf.Value
	12, // 19: vul.common.Vulnerability.data_source:type_name -> vul.common.DataSource
	23, // 20: vul.common.Vulnerability.vendor_severity:type_name -> vul.common.Vulnerability.VendorSeverityEntry
	18, // 21: vul.common.CauseMetadata.code:type_name -> vul.common.Code
	13, // 22: vul.common.CustomResource.layer:type_name -> vul.common.Layer
	25, // 23: vul.common.CustomResource.data:type_name -> google.protobuf.Value
	17, // 24: vul.common.Code.lines:type_name -> vul.common.Line
	18, // 25: vul.common.SecretFinding.code:type_name -> vul.common.Code
	13, // 26: vul.common.SecretFinding.layer:type_name -> vul.common.Layer
	19, // 27: vul.common.Secret.findings:type_name -> vul.common.SecretFinding
	0,  // 28: vul.common.DetectedLicense.severity:type_name -> vul.common.Severity
	1,  // 29: vul.common.DetectedLicense.category:type_name -> vul.common.DetectedLicense.LicenseCategory
	15, // 30: vul.common.Vulnerability.CvssEntry.value:type_name -> vul.common.CVSS
	0,  // 31: vul.common.Vulnerability.VendorSeverityEntry.value:type_name -> vul.common.Severity

...
var file_rpc_common_service_proto_goTypes = []interface{}{
	...
	(*OS)(nil),                       // 1: vul.common.OS
	(*PackageInfo)(nil),              // 2: vul.common.PackageInfo
	(*Application)(nil),              // 3: vul.common.Application
	(*Package)(nil),                  // 4: vul.common.Package
	(*Library)(nil),                  // 5: vul.common.Library
	(*Misconfiguration)(nil),         // 6: vul.common.Misconfiguration
	(*MisconfResult)(nil),            // 7: vul.common.MisconfResult
	(*DetectedMisconfiguration)(nil), // 8: vul.common.DetectedMisconfiguration
	(*Vulnerability)(nil),            // 9: vul.common.Vulnerability
	(*Layer)(nil),                    // 10: vul.common.Layer
	(*CVSS)(nil),                     // 11: vul.common.CVSS
	nil,                              // 12: vul.common.Vulnerability.CvssEntry
	(*timestamppb.Timestamp)(nil),    // 13: google.protobuf.Timestamp
	(*structpb.Value)(nil),           // 14: google.protobuf.Value
}
var file_rpc_common_service_proto_depIdxs = []int32{
	4,  // 0: vul.common.PackageInfo.packages:type_name -> vul.common.Package
	5,  // 1: vul.common.Application.libraries:type_name -> vul.common.Library
	10, // 2: vul.common.Package.layer:type_name -> vul.common.Layer
	7,  // 3: vul.common.Misconfiguration.successes:type_name -> vul.common.MisconfResult
	7,  // 4: vul.common.Misconfiguration.warnings:type_name -> vul.common.MisconfResult
	7,  // 5: vul.common.Misconfiguration.failures:type_name -> vul.common.MisconfResult
	7,  // 6: vul.common.Misconfiguration.exceptions:type_name -> vul.common.MisconfResult
	0,  // 7: vul.common.DetectedMisconfiguration.severity:type_name -> vul.common.Severity
	10, // 8: vul.common.DetectedMisconfiguration.layer:type_name -> vul.common.Layer
	0,  // 9: vul.common.Vulnerability.severity:type_name -> vul.common.Severity
	10, // 10: vul.common.Vulnerability.layer:type_name -> vul.common.Layer
	12, // 11: vul.common.Vulnerability.cvss:type_name -> vul.common.Vulnerability.CvssEntry
	13, // 12: vul.common.Vulnerability.published_date:type_name -> google.protobuf.Timestamp
	13, // 13: vul.common.Vulnerability.last_modified_date:type_name -> google.protobuf.Timestamp
	14, // 14: vul.common.Vulnerability.custom_advisory_data:type_name -> google.protobuf.Value
	14, // 15: vul.common.Vulnerability.custom_vuln_data:type_name -> google.protobuf.Value
	11, // 16: vul.common.Vulnerability.CvssEntry.value:type_name -> vul.common.CVSS

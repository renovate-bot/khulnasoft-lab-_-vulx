...
var file_rpc_scanner_service_proto_goTypes = []interface{}{
	(*ScanRequest)(nil),                     // 0: vul.scanner.v1.ScanRequest
	(*Licenses)(nil),                        // 1: vul.scanner.v1.Licenses
	(*ScanOptions)(nil),                     // 2: vul.scanner.v1.ScanOptions
	(*ScanResponse)(nil),                    // 3: vul.scanner.v1.ScanResponse
	(*Result)(nil),                          // 4: vul.scanner.v1.Result
	nil,                                     // 5: vul.scanner.v1.ScanOptions.LicenseCategoriesEntry
	(*common.OS)(nil),                       // 6: vul.common.OS
	(*common.Vulnerability)(nil),            // 7: vul.common.Vulnerability
	(*common.DetectedMisconfiguration)(nil), // 8: vul.common.DetectedMisconfiguration
	(*common.Package)(nil),                  // 9: vul.common.Package
	(*common.CustomResource)(nil),           // 10: vul.common.CustomResource
	(*common.SecretFinding)(nil),            // 11: vul.common.SecretFinding
	(*common.DetectedLicense)(nil),          // 12: vul.common.DetectedLicense
}
var file_rpc_scanner_service_proto_depIdxs = []int32{
	2,  // 0: vul.scanner.v1.ScanRequest.options:type_name -> vul.scanner.v1.ScanOptions
	5,  // 1: vul.scanner.v1.ScanOptions.license_categories:type_name -> vul.scanner.v1.ScanOptions.LicenseCategoriesEntry
	6,  // 2: vul.scanner.v1.ScanResponse.os:type_name -> vul.common.OS
	4,  // 3: vul.scanner.v1.ScanResponse.results:type_name -> vul.scanner.v1.Result
	7,  // 4: vul.scanner.v1.Result.vulnerabilities:type_name -> vul.common.Vulnerability
	8,  // 5: vul.scanner.v1.Result.misconfigurations:type_name -> vul.common.DetectedMisconfiguration
	9,  // 6: vul.scanner.v1.Result.packages:type_name -> vul.common.Package
	10, // 7: vul.scanner.v1.Result.custom_resources:type_name -> vul.common.CustomResource
	11, // 8: vul.scanner.v1.Result.secrets:type_name -> vul.common.SecretFinding
	12, // 9: vul.scanner.v1.Result.licenses:type_name -> vul.common.DetectedLicense
	1,  // 10: vul.scanner.v1.ScanOptions.LicenseCategoriesEntry.value:type_name -> vul.scanner.v1.Licenses
	0,  // 11: vul.scanner.v1.Scanner.Scan:input_type -> vul.scanner.v1.ScanRequest
	3,  // 12: vul.scanner.v1.Scanner.Scan:output_type -> vul.scanner.v1.ScanResponse

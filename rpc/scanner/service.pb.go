...
var file_rpc_scanner_service_proto_goTypes = []interface{}{
	...
	(*ScanOptions)(nil),                     // 1: vul.scanner.v1.ScanOptions
	(*ScanResponse)(nil),                    // 2: vul.scanner.v1.ScanResponse
	(*Result)(nil),                          // 3: vul.scanner.v1.Result
	(*common.OS)(nil),                       // 4: vul.common.OS
	(*common.Vulnerability)(nil),            // 5: vul.common.Vulnerability
	(*common.DetectedMisconfiguration)(nil), // 6: vul.common.DetectedMisconfiguration
	(*common.Package)(nil),                  // 7: vul.common.Package
}
var file_rpc_scanner_service_proto_depIdxs = []int32{
	1, // 0: vul.scanner.v1.ScanRequest.options:type_name -> vul.scanner.v1.ScanOptions
	4, // 1: vul.scanner.v1.ScanResponse.os:type_name -> vul.common.OS
	3, // 2: vul.scanner.v1.ScanResponse.results:type_name -> vul.scanner.v1.Result
	5, // 3: vul.scanner.v1.Result.vulnerabilities:type_name -> vul.common.Vulnerability
	6, // 4: vul.scanner.v1.Result.misconfigurations:type_name -> vul.common.DetectedMisconfiguration
	7, // 5: vul.scanner.v1.Result.packages:type_name -> vul.common.Package
	0, // 6: vul.scanner.v1.Scanner.Scan:input_type -> vul.scanner.v1.ScanRequest
	2, // 7: vul.scanner.v1.Scanner.Scan:output_type -> vul.scanner.v1.ScanResponse
